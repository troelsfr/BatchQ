from batchq.contrib.alps import runApplicationBackground, NoHUPSSH, LSFBSub, load_queue,DescriptorQ
import pyalps
...
settings = {'command': ".", 'username':"tfr", 'server':"satis.ethz.ch", 'port':22, 'working_directory':"/tmp/", 'input_directory':"/tmp/", 'output_directory':"/tmp/", 'q_interact':True, "options": "", "prior":"", "post":""}
